...
# Mesma regra de aulas/aula02/aula02.py, onde os 250 eram uma variável solta
# chamada valor_minimo_frete_gratis. O acréscimo desta aula é a embalagem: a
# regra ganhou nome, entrada e saída, e passou a existir num lugar só.
...
#
#      13  def calcular_frete(subtotal):
...
#
#      26  assert calcular_frete(300.00) == 0.0
#          Cenário acima da fronteira.
#
#      27  assert calcular_frete(100.00) == 20.0
#          Cenário abaixo da fronteira.
#
#      28  assert calcular_frete(250.00) == 0.0
#          A fronteira exata, e é o assert que vale mais que os outros dois.
#          Se alguém trocar o >= por > na linha 14, só este falha.
#
#      29  print("As três verificações passaram")
