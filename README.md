...
```bash
python aulas/aula03_operadores.py
```
...
### `aulas/aula03_login_evidencia.py`

A evidência esperado x obtido no caso de teste de login da Aula 02, com a mesma massa do
`aulas/aula02_login.py`. Cada linha agora compara o esperado com o obtido e imprime o veredito:
...
```bash
python aulas/aula03_login_evidencia.py
```
...
```bash
python aulas/aula03_desconto.py
```
...
### `aulas/aula03_desconto_invertido.py`
...
```bash
python aulas/aula03_desconto_invertido.py
```
...
```bash
python aulas/aula03_gate_release.py
```
...
```bash
python aulas/aula03_defeitos.py
```
...
```bash
python aulas/aula03_operadores.py; python aulas/aula03_login_evidencia.py; python aulas/aula03_desconto.py; python aulas/aula03_desconto_invertido.py; python aulas/aula03_gate_release.py; python aulas/aula03_defeitos.py
```
